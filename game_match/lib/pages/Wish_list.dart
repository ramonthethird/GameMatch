...
class _WishlistPageState extends State<WishlistPage> {
  ...
  final List<Product> _products = [
    Product(name: 'Satisfactory', price: 19.99, platforms: 'PC, Playstation 5, Xbox', imageUrl: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co8tfy.webp'),
    Product(name: 'Dragon Ball: Sparking! Zero', price: 35.99, platforms: 'PC, Playstation 5, Xbox', imageUrl: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co8bhn.webp'),
    Product(name: 'Silent Hill 2', price: 0.00, platforms: 'PC, Playstation 5', imageUrl: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co5l7s.webp'),
    Product(name: 'EA Sports FC 25', price: 55.99, platforms: 'Nintendo Switch, PC, Playstation 5, Xbox', imageUrl: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co8lno.webp'),
    Product(name: 'Black Myth: Wukong', price: 45.99, platforms: 'PC, Playstation 5, Xbox', imageUrl: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co8h3y.webp'),
