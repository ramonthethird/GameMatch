    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          ...
          style: TextStyle(
            color: Colors.white,
            fontSize: 24, // Text size set to 24
          ),
        ),
...
ListTileTheme(
  selectedColor: Color(0xFF41B1F1), // Set the color for selected items
  child: ListTile(
    ...
    trailing: Radio(
      value: 'free',
      groupValue: 'free',
      onChanged: (_) {}, // Use a no-op function instead of null to keep it enabled
      activeColor: Color(0xFF41B1F1), // Set the active color to blue
    ),
  ),
),
            ...
            ListTile(
              ...
              subtitle: const Text('Not Active'), // Changed from Active to Not Active
            ),
            const SizedBox(height: 20),
              ...
              child: ListTile(
                ...
                trailing: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF41B1F1), // Upgrade button background color
                    foregroundColor: Colors.white, // Upgrade button text color
                  ),
